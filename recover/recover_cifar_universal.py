...
def get_images(args, model_teacher, hook_for_display, ipc_id):
    ...
    for kk in range(0, 100, batch_size):
        ...
        # partly reinit_zx
        loaded_tensor = torch.load(args.init_path+'/tensor_'+str(ipc_id%(args.ipc_end - 1))+'.pt').clone().requires_grad_(True).to('cuda')
...
if __name__ == "__main__":
    ...
    for ipc_id in range(args.ipc_start, args.ipc_end * 2 - 2):
        print("ipc = ", ipc_id)
